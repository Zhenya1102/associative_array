...
function App() {
    ...
    function removeTask(todolistId:string,id: string) {
        setTasks({...tasks,[todolistId]:tasks[todolistId].filter(removed => removed.id !== id)})
    }
    ...
    function changeStatus(todolistId:string,taskId: string, isDone: boolean) {
        ...
        let task = {...tasks,[todolistId]:tasks[todolistId].map(changed=> changed.id === taskId ? {...changed,isDone} : changed)}
        setTasks(task);
    }
